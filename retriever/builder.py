...
class RetrieverBuilder:
    def __init__(self):
        ...
        # This just loads the model that will turn text into vectors
        # and saves it on self so every method in the class can reuse the same one
    ...
    # This method takes your chunked documents and turns them into one 
    # combined retriever that can search 2 different ways at once.
